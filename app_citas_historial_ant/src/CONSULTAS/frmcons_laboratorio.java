 ...
 * @author UNSAAC
 */
public class frmcons_laboratorio extends javax.swing.JFrame {
    claboratorio oclaboratorio = new claboratorio();

    /**
     * Creates new form frmConsultaCurso
     */
    public frmcons_laboratorio() {
        initComponents();
        listar_laboratorio("");
    ...
    void listar_laboratorio(String pcodAlumno){
        DefaultTableModel modelo_laboratorio = oclaboratorio.listar_laboratorio(pcodAlumno);
        tblcons_laboratorio.setModel(modelo_laboratorio);
    }
    ...
    private void initComponents() {
        ...
        tblcons_laboratorio = new javax.swing.JTable();
        ...
        tblcons_laboratorio.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblcons_laboratorio);
    ...
    private void txtbuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyTyped
        ...
        rst = new TableRowSorter(tblcons_laboratorio.getModel());
        tblcons_laboratorio.setRowSorter(rst);
    }//GEN-LAST:event_txtbuscarKeyTyped

    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
                  
        int FilaSelec = tblcons_laboratorio.getSelectedRow();
        if (FilaSelec >= 0) {
        String dato [] = new String [2];
        dato [0] = (tblcons_laboratorio.getValueAt(FilaSelec, 0).toString());
        dato [1] = (tblcons_laboratorio.getValueAt(FilaSelec, 1).toString());
        frmmanespecialidad.txtid_laboratorio.setText(dato[0]);
        frmmanespecialidad.txtnombre_laboratorio.setText(dato[1]);
        dispose();}
        else{
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        frmmanlaboratorio fcat=new frmmanlaboratorio();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmcons_laboratorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmcons_laboratorio().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblcons_laboratorio;
