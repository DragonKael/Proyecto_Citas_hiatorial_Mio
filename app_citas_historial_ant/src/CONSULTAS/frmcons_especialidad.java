 ...
 */
package CONSULTAS;
import static CONSULTAS.frmcons_usuario.lbltitulo_cons;
 ...
 * @author UNSAAC
 */
public class frmcons_especialidad extends javax.swing.JFrame {
    cespecialidad ocespecialidad = new cespecialidad();
    /**
     * Creates new form frmConsultaCurso
     */
    public frmcons_especialidad() {
        initComponents();
        listar_especialidad("");
    ...
    void listar_especialidad(String pcodAlumno){
        DefaultTableModel modelo_especialidad = ocespecialidad.listar_especialidad(pcodAlumno);
        tblcons_especialidad.setModel(modelo_especialidad);
    }
        
    void form_abierto(){
        if(lbltitulo_cons.getText().equals("Consulta Especialidad para Medico")){
            int FilaSelec = tblcons_especialidad.getSelectedRow();
            if (FilaSelec >= 0) {
            String dato [] = new String [2];
            dato [0] = (tblcons_especialidad.getValueAt(FilaSelec, 0).toString());
            dato [1] = (tblcons_especialidad.getValueAt(FilaSelec, 2).toString());
            
            frmmanmedico.txtid_especialidad.setText(dato[0]);
            frmmanmedico.txtnombre_especialidad.setText(dato[1]);
            dispose();}
            else{
        ...
        if(lbltitulo_cons.getText().equals("Consulta Especialidad para Reserva")){
            int FilaSelec = tblcons_especialidad.getSelectedRow();
            if (FilaSelec >= 0) {
            String dato [] = new String [2];
            dato [0] = (tblcons_especialidad.getValueAt(FilaSelec, 0).toString());
            dato [1] = (tblcons_especialidad.getValueAt(FilaSelec, 1).toString());
            
            frmmanreserva.txtid_especialidad.setText(dato[0]);
            frmmanreserva.txtnombre_especialidad.setText(dato[1]);
            dispose();}
            else{
                JOptionPane.showMessageDialog(null,"Seleccione algo");
            }
    ...
    private void initComponents() {
        ...
        tblcons_especialidad = new javax.swing.JTable();
        ...
        lbltitulo_cons.setText("Lista de Especialidades");
        ...
        tblcons_especialidad.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblcons_especialidad);
    ...
    private void txtbuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyTyped
        ...
        rst = new TableRowSorter(tblcons_especialidad.getModel());
        tblcons_especialidad.setRowSorter(rst);
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        frmmanespecialidad fcat=new frmmanespecialidad();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmcons_especialidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmcons_especialidad().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblcons_especialidad;
