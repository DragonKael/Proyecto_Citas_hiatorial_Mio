 ...
 * @author UNSAAC
 */
public class frmcons_categoria extends javax.swing.JFrame {
    ccategoria occategoria = new ccategoria();

    /**
     * Creates new form frmConsultaCurso
     */
    public frmcons_categoria() {
        initComponents();
        listar_categoria("");
    ...
    void listar_categoria(String pcodAlumno){
        DefaultTableModel modelo_categoria = occategoria.listar_categoria(pcodAlumno);
        tblconscategoria.setModel(modelo_categoria);
    }
    ...
    private void initComponents() {
        ...
        tblconscategoria = new javax.swing.JTable();
        ...
        tblconscategoria.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblconscategoria);
    ...
    private void txtbuscarcategoriaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarcategoriaKeyTyped
        txtbuscarcategoria.addKeyListener(new KeyAdapter() {
            ...
            {
                rst.setRowFilter(RowFilter.regexFilter("(?i)"+txtbuscarcategoria.getText(), 1));
            }
        });
        rst = new TableRowSorter(tblconscategoria.getModel());
        tblconscategoria.setRowSorter(rst);
    }//GEN-LAST:event_txtbuscarcategoriaKeyTyped

    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        int FilaSelec = tblconscategoria.getSelectedRow();
        if (FilaSelec >= 0) {
        String dato [] = new String [2];
        dato [0] = (tblconscategoria.getValueAt(FilaSelec, 0).toString());
        dato [1] = (tblconscategoria.getValueAt(FilaSelec, 1).toString());
        frmmanespecialidad.txtid_categoria.setText(dato[0]);
         frmmanespecialidad.txtnombre_categoria.setText(dato[1]);
        dispose();}
        else{
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        frmmancategoria fcat=new frmmancategoria();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmcons_categoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmcons_categoria().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblconscategoria;
